#
#  Be sure to run `pod spec lint PBTutorialManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "paul1893"
  # s.authors            = { "paul1893" => "pspol@hotmail.fr" }
  ...
  s.source       = { :git => "https://github.com/paul1893/PBTutorialManager.git", :tag => "1.0.0" }
  ...
  s.source_files  = "PBTutorialManager/**/*.{swift}"
  s.exclude_files = "PBTutorialManager/Example/**/*"
  s.exclude_files = "PBTutorialManager/AppDelegate.swift"
  s.exclude_files = "PBTutorialManager/Base.lproj/**/*"
